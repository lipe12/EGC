///
	...
	Ext.onReady(function(){              
	   ...
	   tabs = new Ext.TabPanel({
            ...
            listeners: {      
				'tabchange': function() {
				    if(tabs.getActiveTab().id=='EarthTab'||tabs.getActiveTab().id=="data_manager_grid"){   
	        ...
	        //the second tab: "Model" tab panel 
			{
	            title: 'Model',
	            id: 'easyModel', 
	            xtype:'panel', 
       ...
       items: [      
           { 
              ...
              html: '<div id="header">'
                             +'<table width="100%">'
                             +'<tr class="banner">'
                             +'<td class="banner" width="50px">'  
                             +'<img src="img/globe_25.gif" width=25px height=25px alt="World picture" align="top">'
                             +'<img src="img/EGC.jpg" width=25px height=25px alt="GeoNetwork opensource logo" align="top">'
                             +'</td>'
                             +'<td>'                
                             //+'<label  style="color: #009999;font-size: 15pt;">&nbsp;&nbsp;&nbsp;Easy GeoComputation PlatForm</label>'
							 +'<label  style="color: #009999;font-size: 15pt;">&nbsp;&nbsp;&nbsp;CyberSoLIM: Easy Digital Soil Mapping PlatForm</label>'
                             +'</td>'                    
                             +'<td align="right" width="450px">'                                 
                             +'<label id="welcome_label" style="color: #99CC00;font-size: 10pt;">' + welcomewords + '</label>&nbsp;&nbsp;&nbsp;&nbsp;' 
                             +'</td>'               
                             ...
                             +'<button id="userlogout_btn" onclick="userlogout()" style="display:' + logout_flag + ';background-color:#FFFFFF;border-bottom:1px solid #FFFFFF;;border-right:1px solid #FFFFFF"><font color="#666666"; style="TEXT-DECORATION: underline">Logout</font></button>'    
                             +'</td>'        
                             +'<td align="right" width="30px">'                 
                             +'<button id="group_btn" onclick="groupOperation1()" style="background-color:#FFFFFF;border-bottom:1px solid #FFFFFF;;border-right:1px solid #FFFFFF"><font color="#666666"; style="TEXT-DECORATION: underline">Group</font></button>'  
                             +'</td>'              
                             +'</tr>'                        
                             +'</table>'            
                             +'</div>',                  
           ...
           {region:'south',html:'<font face="Times New Roman" size="3" color="#666666">Copyright &copy; 2013-2014 Institute of Geographic Sciences and Natural Resources Research, CAS. All rights reserved.</font>',height:30},
           tabs
       ]
   });
