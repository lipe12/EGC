				...
				listeners: {
				   click: function() {       
					  ...
					  var com = {  
					   ...
					   //Others.add(check);     
					   //Ext.getCmp('Env_Others').add(check);
					   //Ext.getCmp('Env_Others').add(com);
...
GeoExt.createOutputDataWindow = function(_data,_graphManager){  
    ...
    var _selectFun = function(){
	    ...
	    var filename = dataName + nowtime + format;  
	...
	if(Ext.getCmp('SelectAlgorithmFormWin')== undefined){
		...
		Ext.getCmp('SelectAlgorithmFormWinOK').on("click" , function(){                   
			...
			if(currentOutput.dataName == 'Presence Sites'){
				filename = currentOutput.dataName + nowtime + ".shp";
			}else{ 
				filename = currentOutput.dataName + nowtime + ".asc";
			}
