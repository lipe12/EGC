...
public class ListTreeContent extends ActionSupport
{
	private JSONObject js = new JSONObject();

	private String responseArrayString;
	...
	// public String getResponseArrayString() {
	// return responseArrayString;
	// }
	// public void setResponseArrayString(String responseArrayString) {
	// this.responseArrayString = responseArrayString;
	// }
	...
	/**
	 * this function is to return the node of
	 */
	public String returnTreeNodes()
	{
		...
		js.element("children", array.toString());
		responseArrayString = js.toString();
		return SUCCESS;
	}
}
